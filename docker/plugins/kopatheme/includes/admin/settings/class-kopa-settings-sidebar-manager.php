...
class Kopa_Settings_Sidebar_Manager extends Kopa_Settings_Page {
	...
	public function __construct() {
		...
		$this->label = esc_html__( 'Sidebar Manager', 'kopatheme' );
	...
	public function get_page_settings() {
		...
		return apply_filters( 'kopa_sidebar_manager_settings', array(
			array(
				'title'   => esc_html__( 'Sidebar Manager', 'kopatheme' ),
				'type' 	  => 'title',
				'id' 	  => 'sidebar-title',
			),
			array(
				'title'       => 'Sidebar Manager',
				'description' => esc_html__( 'Add as many sidebars (widget areas) as you need. Creating sidebars (widget areas) is unlimited.', 'kopatheme' ),
				'id'          => 'sidebar-manager',
