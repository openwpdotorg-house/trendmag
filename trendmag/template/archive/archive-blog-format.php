<?php
$sb_top   = apply_filters('trendmag_get_sidebar', 'sb_blog_top', 'pos_blog_top');
...
if ( $trendmag_current_layout ) {
    ...
    if ( isset($trendmag_sidebar['sb_blog_top']) ) {
        $sb_top = $trendmag_sidebar['sb_blog_top'];
    }
